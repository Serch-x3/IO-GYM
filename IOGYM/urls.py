...
urlpatterns = [
    ...
    path('admin/memberships/edit/<int:pk>', login_required(views.membershipEditMethod), name='edit membership'),
    #path('admin/memberships/delete/<int:pk>', login_required(MembershipDelete.as_view()),name='create membership'),



    # PAYMENTS
    path('admin/payments/', login_required(PaymentList.as_view(template_name="admin/payments/index.html")), name='index payment'),
    ...
    path('clients/create/membership/<int:pk>', login_required(views.membershipEditFromCreateMethod), name='edit membership from create'),
