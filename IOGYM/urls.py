...
urlpatterns = [
    ...
    path('admin/memberships/', login_required(GymClassesList.as_view())),
    ...
    #TRAINER ATTENDANCES
    path('trainers/attendances/', login_required(FilterView.as_view(filterset_class=TrainersAttendancesFilter,template_name='trainers/attendances.html')), name='search client Attendance'),
    path('trainers/attendances/', login_required(trainerAttendanceList.as_view(template_name = "trainers/attendances.html")), name='trainers registros'),
    #TRAINER ATTENDANCE MODE
    path('trainers/attendancemode/', login_required(trainersAttendance.as_view(template_name = "trainers/attendanceMode.html")), name='trainer asistencia'),
    ...
    path('trainers/attendancemode/checkClientAttendance/<int:pk>', login_required(views.trainerChecking)),
    ...
    path('clients/create', login_required(ClientCreate.as_view(template_name = "clients/create.html")), name='crear'),
    ...
    path('clients/attendances/', clientsView.as_view(template_name = "clients/attendances.html"), name='admin asistencias'),
]
